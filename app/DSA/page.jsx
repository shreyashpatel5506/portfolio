            ...
            <div className="bg-[#282828] rounded-xl p-4 shadow-sm">
              <div className="flex gap-4 items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-xs mt-1">
                    Rank{" "}
                    <span className="font-bold text-[#eff2f6] text-sm">
              ...
              <div className="mt-6 space-y-3 text-sm text-gray-400">
                ...
                {stats.profile?.school && (
                  <div className="flex items-center gap-3">
                    <Building2 size={16} />{" "}
                    <span className="text-[#eff2f6] truncate">
                      {stats.profile.school}
                    </span>
                  </div>
                )}
              ...
              {stats.profile?.skillTags &&
                stats.profile.skillTags.length > 0 && (
            ...
            <div className="bg-[#282828] rounded-xl p-4 shadow-sm">
              ...
              <div className="space-y-4 text-sm">
                <div className="flex items-center gap-3 text-gray-400">
                  ...
                  <span>Views</span>
                  <span className="ml-auto font-medium text-[#eff2f6]">
                    6.8K
                  </span>
                </div>
                <div className="flex items-center gap-3 text-gray-400">
                ...
                {stats.languageProblemCount?.slice(0, 3).map((lang, i) => (
                  <div key={i} className="flex justify-between items-center">
                    ...
                    <span className="text-gray-400">
                      <span className="text-[#eff2f6] font-semibold">
                        {lang.problemsSolved}
                      </span>{" "}
            ...
            <div className="bg-[#282828] rounded-xl p-4 shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between relative overflow-hidden">
              <div className="flex gap-8 z-10 relative">
                <div>
                  ...
                  <div className="text-[28px] text-[#eff2f6] font-semibold">
                    {Math.round(stats.contest?.rating || 0).toLocaleString()}
                  </div>
                </div>
                <div>
                  <div className="text-gray-400 text-xs mb-1">
                  ...
                  <div className="text-[28px] text-gray-500 font-semibold">
                    {stats.contest?.globalRanking?.toLocaleString() || "🔒"}
                  </div>
                </div>
                <div>
                  <div className="text-gray-400 text-xs mb-1">Attended</div>
                  <div className="text-[28px] text-[#eff2f6] font-semibold">
                    {stats.contest?.attendedContestsCount || 0}
                  </div>
                </div>
              </div>
              ...
              >
                <div className="flex justify-between items-start mb-6">
                  <div>
                    ...
                    <div className="text-3xl font-semibold text-[#eff2f6]">
                ...
                <div className="mt-auto">
                  ...
                  {stats.badges?.length > 0 ? (
                    <div className="flex items-center gap-3">
                      <img
                        src={getFullIconUrl(stats.badges[0].icon)}
                        alt="Badge"
                ...
                {stats.badges?.length > 0 && stats.badges[1] && (
                  <img
                    src={getFullIconUrl(stats.badges[1].icon)}
                    className="absolute -right-6 -bottom-6 w-32 h-32 opacity-10 object-contain pointer-events-none"
                  />
                )}
              </div>
            </div>
            ...
            <div className="bg-[#282828] rounded-xl p-6 shadow-sm">
              <div className="text-gray-400 text-sm mb-6 flex items-center">
                ...
                <span className="ml-auto text-xs text-gray-500 flex gap-4">
                  <span>
                    Total active days:{" "}
                    <span className="text-[#eff2f6]">113</span>
                  </span>
                  <span>
                    Max streak: <span className="text-[#eff2f6]">41</span>
                  </span>
                </span>
              </div>
              {renderHeatmap()}
              ...
              <div className="flex gap-2 p-2 bg-[#2c2c2c] border-b border-[#3e3e3e] overflow-x-auto custom-scrollbar">
                ...
                {activeTab === "solutions" && (
                  <div className="ml-auto text-xs text-gray-500 flex items-center gap-4 px-2 whitespace-nowrap">
                    <span className="text-[#eff2f6] flex items-center gap-1 cursor-pointer">
                      <Activity size={12} /> Most Recent
                    </span>
                    <span className="hover:text-[#eff2f6] flex items-center gap-1 cursor-pointer">
                      <ThumbsUp size={12} /> Most Votes
                    </span>
                  </div>
                )}
                {activeTab !== "solutions" && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="ml-auto text-xs text-blue-400 hover:text-blue-300 flex items-center self-center px-2 whitespace-nowrap"
                  >
                    View all{" "}
                    {activeTab === "recent" ? "submissions" : activeTab}{" "}
                      ...
                      >
                        ...
                        <div className="flex items-center gap-4 text-gray-500 text-xs shrink-0">
                          ...
                          <span className="flex items-center gap-1.5">
                            <ThumbsUp size={12} /> {sol.post?.voteCount || 0}
                          </span>
                          <span className="flex items-center gap-1.5">
                            <Eye size={14} /> {sol.viewCount || 0}
                          </span>
                        </div>
                      </a>
                    ))
                      ...
                      {groupedBadges[category].map((badge, idx) => (
                        ...
                        >
                          <div className="w-16 h-16 relative flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300">
                            <img
                              src={getFullIconUrl(
                                badge.medal?.config?.icon || badge.icon,
                              )}
