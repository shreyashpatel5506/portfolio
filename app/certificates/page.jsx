...
import { ExternalLink, Award, X, Maximize2, Calendar, ShieldCheck } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          {loading ? (
                ...
                >
                  ...
                  <div className="p-6 flex flex-col flex-grow relative">
                    ...
                    <div className="flex-grow mt-6">
                      <h3 className="text-xl font-bold text-slate-100 mb-2 leading-snug group-hover:text-violet-400 transition-colors">{cert.title}</h3>
                      <p className="text-violet-300 text-sm font-medium mb-3">{cert.issuer}</p>
            ...
            <div className="py-32 flex flex-col items-center justify-center text-center border border-dashed border-slate-800 rounded-3xl max-w-2xl mx-auto">
              ...
              <p className="text-slate-400 text-lg">Check back later for new credentials.</p>
            </div>
          )}
        </div>
      </AnimatedSection>
              ...
              <div className="w-full md:w-[40%] p-8 flex flex-col justify-center bg-gradient-to-b from-[#0b0f19] to-[#030712] border-l border-slate-800/50 overflow-y-auto max-h-[90vh] md:max-h-none">
                ...
                <div className="space-y-6 mb-10">
                  <div className="flex flex-col">
                    <span className="text-xs uppercase tracking-widest text-slate-500 font-bold mb-1">Issue Date</span>
                  ...
                  {selectedCert.expirationDate && (
                    <div className="flex flex-col">
                      <span className="text-xs uppercase tracking-widest text-slate-500 font-bold mb-1">Expiration Date</span>
                      <span className="text-slate-200 text-lg flex items-center gap-2">
                        <Calendar size={18} className="text-slate-400" />
                  ...
                  {selectedCert.credentialId && (
                    <div className="flex flex-col">
                      <span className="text-xs uppercase tracking-widest text-slate-500 font-bold mb-1">Credential ID</span>
